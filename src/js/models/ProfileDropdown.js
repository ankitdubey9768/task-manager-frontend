...
export const removeProfilePic = async () => {
    ...
    const response = await axios.delete(`${proxy}https://ankitdubey9768-task-manager.herokuapp.com/users/me/avatar`, {
        headers: {
...
export const uploadProfilePic = async (file) => {
    ...
    const proxy = 'https://cors-anywhere.herokuapp.com/';
    const response = await axios.post(`${proxy}https://ankitdubey9768-task-manager.herokuapp.com/users/me/avatar`, data , {
        headers: {
...
export const getProfilePic = async (id) => {
    const proxy = 'https://cors-anywhere.herokuapp.com/';
    const response = await axios.get(`${proxy}https://ankitdubey9768-task-manager.herokuapp.com/users/${id}/avatar`, {
        headers: {
            'Content-Type': 'application/json',
            'Access-Control-Allow-Origin': '*',
